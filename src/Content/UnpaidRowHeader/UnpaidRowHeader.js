import '..//UnpaidRowHeader//UnpaidRowHeader.css';

function UnpaidRowHeader(props){  
    return (
        <div style={{padding: "0px"}} className="col-lg-12" id="mainHeaderDiv">
            ...
            <div className="col-md-1 col-sm-1 col-lg-1 col-xs-1 col-xl-1" style={{minWidth: "100px", maxWidth: "130px"}}>
...
export default UnpaidRowHeader;